#!/usr/bin/env python3
"""
Headless USB Keypad Control for Sony Projector System
Works over SSH without X server requirements
Uses evdev for direct USB device input
"""
...
class HeadlessUSBKeypadController:
    """Headless USB keypad controller using evdev"""
    ...
    def __init__(self, projectors: list, debug_mode: bool = True):
        ...
        # These are common key codes for Cut/Copy/Paste/Enter keypads
        self.key_mappings = {
        ...
        logging.basicConfig(
            ...
            handlers=[
                logging.FileHandler('usb_keypad_control_headless.log'),
    ...
    def find_usb_keypad(self):
        ...
        try:
            ...
            for device in devices:
                ...
                # Check capabilities for key events
                if ecodes.EV_KEY in device.capabilities():
                    print(f"✅ Found input device: {device.name} at {device.path}")
                    return device
...
def main():
    ...
    controller = HeadlessUSBKeypadController(
